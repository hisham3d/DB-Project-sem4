...
namespace Project_FrontEnd
{
    public partial class AdminReportForm : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = @"SELECT AssignedRegion, COUNT(*) AS Count 
                         FROM Admin 
                         GROUP BY AssignedRegion";
                ...
                chart1.Series.Clear();
                chart1.Titles.Clear();
                chart1.Titles.Add("Admin Count by Region");
                ...
                {
                    string region = row["AssignedRegion"].ToString();
                    int count = Convert.ToInt32(row["Count"]);
                    series.Points.AddXY(region, count);
                }

                // Optional: apply colorful palette
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                ReportDataSource source = new ReportDataSource("AdminDataSet", dt);
                reportViewer1.LocalReport.ReportPath = "D:\\Project\\Project\\Project_FrontEnd\\AdminReport.rdlc";
