...
namespace Project_FrontEnd {
    ...
    public partial class formsDataSet : global::System.Data.DataSet {
        ...
        public partial class RegistrationDataTable : global::System.Data.TypedTableBase<RegistrationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public RegistrationRow AddRegistrationRow(string username, string password, string name, string email, System.DateTime dob, string phone, string city, string gender) {
        ...
        public partial class RegistrationRow : global::System.Data.DataRow {
            ...
            public string phone {
                get {
                    try {
                        return ((string)(this[this.tableRegistration.phoneColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsphoneNull() {
                return this.IsNull(this.tableRegistration.phoneColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetphoneNull() {
                this[this.tableRegistration.phoneColumn] = global::System.Convert.DBNull;
            }
...
namespace Project_FrontEnd.formsDataSetTableAdapters {
    ...
    public partial class RegistrationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Registration] ([username], [password], [name], [email], [dob], [phone], [city], [gender]) VALUES (@username, @password, @name, @email, @dob, @phone, @city, @gender);
SELECT username, password, name, email, dob, phone, city, gender FROM Registration WHERE (username = @username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Registration] SET [username] = @username, [password] = @password, [name] = @name, [email] = @email, [dob] = @dob, [phone] = @phone, [city] = @city, [gender] = @gender WHERE (([username] = @Original_username) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_dob = 1 AND [dob] IS NULL) OR ([dob] = @Original_dob)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)));
SELECT username, password, name, email, dob, phone, city, gender FROM Registration WHERE (username = @username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DEMON\\SQLEXPRESS;Initial Catalog=forms;Integrated Security=True;Encry" +
                "pt=False";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT username, password, name, email, dob, phone, city, gender FROM dbo.Registr" +
                "ation";
        ...
        public virtual int Fill(formsDataSet.RegistrationDataTable dataTable) {
        ...
        public virtual formsDataSet.RegistrationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            formsDataSet.RegistrationDataTable dataTable = new formsDataSet.RegistrationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(formsDataSet.RegistrationDataTable dataTable) {
        ...
        public virtual int Delete(string Original_username, string Original_password, string Original_name, string Original_email, global::System.Nullable<global::System.DateTime> Original_dob, string Original_phone, string Original_city, string Original_gender) {
        ...
        public virtual int Insert(string username, string password, string name, string email, global::System.Nullable<global::System.DateTime> dob, string phone, string city, string gender) {
            if ((username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string password, string name, string email, global::System.Nullable<global::System.DateTime> dob, string phone, string city, string gender, string Original_username, string Original_password, string Original_name, string Original_email, global::System.Nullable<global::System.DateTime> Original_dob, string Original_phone, string Original_city, string Original_gender) {
            return this.Update(Original_username, password, name, email, dob, phone, city, gender, Original_username, Original_password, Original_name, Original_email, Original_dob, Original_phone, Original_city, Original_gender);
        }
    }
