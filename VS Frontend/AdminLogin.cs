    ...
    public partial class AdminLogin : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    this.Hide();
                    AdminMainPage adminMain = new AdminMainPage(adminID);
                    adminMain.Show();
                }
                else
                {
                    MessageBox.Show("Admin does not exist or credentials are incorrect.", "Login Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            catch (Exception ex)
            {
